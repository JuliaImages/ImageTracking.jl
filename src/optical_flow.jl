...
Neighbourhood size over which information will be intergrated when determining the
...
"""
struct Farneback{F <: Float64, I <: Int} <: OpticalFlowAlgo
    iterations::I
    estimation_window::I
...
"""
struct LucasKanade{F <: Float64, I <: Int}  <: OpticalFlowAlgo
    window_size::I
    max_level::I
    iterations::I
